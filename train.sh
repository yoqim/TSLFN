...
# python train.py --dataset sysu --trial 1 --gpu 0 --share_net 2 --w_hc 0.5 --per_img 8 --lr 1e-2 --epochs 200 

python train_graph.py --dataset sysu --gpu 1 --share_net 3 --w_hc 0.5 --per_img 8 --lr 1e-2 --epochs 200 
# python train_graph.py --dataset regdb --trial 1 --gpu 0 --share_net 3 --w_hc 0.5 --per_img 8 --lr 1e-2 --epochs 200 
